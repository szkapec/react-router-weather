...
const Legenda = () => {
    ...
    return(
        ...
        <>
            <h3 className="container__table-h3">Informacje o jakości powietrza</h3>
           ...
           <tr  style={{backgroundColor: '#ffde33', border:'4px solid red'}}>
               ...
               <th>Aktywne dzieci i dorośli oraz osoby z chorobami układu oddechowego, takimi jak astma, powinny ograniczyć przedłużony wysiłek na świeżym powietrzu.</th>
           </tr>
           ...
           <tr style={{backgroundColor: '#cc0033'}}>
                ...
                <th>Aktywne dzieci i dorośli oraz osoby z chorobami układu oddechowego, takimi jak astma, powinny unikać przedłużonego wysiłku na świeżym powietrzu; wszyscy inni, zwłaszcza dzieci, powinni ograniczać przedłużony wysiłek na świeżym powietrzu</th>
           </tr>
           <tr style={{backgroundColor: '#660099'}}>
                ...
                <th>Aktywne dzieci i dorośli oraz osoby z chorobami układu oddechowego, takimi jak astma, powinny unikać wszelkiego wysiłku na świeżym powietrzu; wszyscy inni, zwłaszcza dzieci, powinni ograniczyć wysiłek na świeżym powietrzu.</th>
           </tr>
           </tbody>
